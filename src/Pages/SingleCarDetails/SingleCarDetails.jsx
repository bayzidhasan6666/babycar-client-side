  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-900">
      <div className="border border-purple-700 rounded-lg shadow-lg p-8 max-w-md text-white">
        ...
        <h3 className="text-lg text-purple-500 mb-2">Name: {toy.name}</h3>
        <p className="text-teal-400 mb-2">Price: {toy.price}</p>
        <p className="text-red-400 mb-4">Rating: {toy.rating}</p>
